...
{
    public class GillsInfusion : ModPrefix
    {
        public override PrefixCategory Category => PrefixCategory.Accessory;
        public override float RollChance(Item item)
        {
            if (Main.player[Main.myPlayer].HasItem(ModContent.ItemType<LightPurpleCrystalTier1>()) == true)
            {
                return 0.2f;
            }
            else
        ...
        {
            player.AddBuff(BuffID.Gills, 1, true, false);
        }
